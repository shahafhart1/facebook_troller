$karnivor_sentances = ["בשר זה טעים רצח","מממ... סטייק"]
$tivoni_sentances = ["בשר זה רצחחחחח","אתם כולכם רוצחים"]
$smolani_sentances = ["ליכודניקים חסרי תרבות","מירי רגב בהמה"]
$yemani_sentances = ["כהנא צדק","מירי רגב","מירי רגב שולטתתתת"]
